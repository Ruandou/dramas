...
> 改编自 0xsline 反派设计框架，适配 86 集短剧格式。与 story-architect 的满足感编码（satisfaction codes）联动。**时间线以 story-architect 框架六（86 集刻度）为准**，本节集号与其保持一致，冲突时以 story-architect 为权威源。

### 第一层：小反派（Minor Villain，EP1-22）

| 维度 | 内容 |
|------|------|
| 定位 | 眼前障碍，建立世界观和初始冲突 |
| 时间线 | EP1-3 引入，EP17-22 被击败（败露时牵出第二层） |
| 特征 | 小气、可见的残忍、容易让人恨 |
| 要求 | 必须是主角无法忽视的人（直属上级、家族成员等） |
| 击败触发 | SAT-SLAP（打脸满足感） |

### 第二层：中层 Boss（Mid-Boss，EP1-10 暗示，EP18-57 活跃）

| 维度 | 内容 |
|------|------|
| 定位 | 更深层威胁，关联更大阴谋；揭露"系统是不公平的" |
| 时间线 | EP1-10 可作配角/盟友出现（隐藏身份），EP18-29 显露敌意，EP36-57 间被击败 |
| 特征 | 有策略、利用代理人/规则/系统对付主角 |
| 要求 | 必须有**逻辑原因**与主角对立（不是纯粹邪恶） |
| 击败触发 | SAT-COME（逆袭满足感） |
| 对抗节奏 | ①初次交锋（平手）→ ②中层 Boss 反击（主角受挫）→ ③主角智取/力压 |

### 第三层：大 Boss（Big Boss，EP24-74）

| 维度 | 内容 |
|------|------|
| 定位 | 幕后真正权力，代表系统性不公 |
| 时间线 | EP24 前后模糊线索（名字/传闻/背影），EP36-48 正式现身，EP66-74 终极对决 |
...
|------|------|
| 定位 | 终极反转——主角/观众信任的某个人 |
| 时间线 | EP1 起以盟友/中立身份在场，EP57-72 真面目揭露，EP78-86 终极对决 |
| 特征 | 前期有帮助、微妙操控、长线布局 |
...
| 阶段 | 时间 | 内容 |
|------|------|------|
| 线索 1 | EP1-13（起势期） | 当时看起来没问题的小细节 |
| 线索 2 | EP14-39（攀升期） | 可疑行为但有合理解释 |
| 线索 3 | EP40-56（风暴期前半） | 差点被揭穿，被其他事件打断 |
| 揭露 | EP57-72 | 所有线索串联，真相大白 |
...
- 痛点节奏：EP1-3 建立 → EP4-48 反复按压 → EP49-86 逐一解决/治愈
