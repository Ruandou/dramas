...
| 潜台词 | 关键冲突/情感戴面具场景台词携带潜台词（定性，v2.0 删除 30% 数字比例） | 请求 scene-writer 补充潜台词层次 |
| 对白占比 | 对白（非 `[内心]`/`[内心独白]`/`旁白`）行数 ÷ 全部 spoken lines ≥ 85%（听心声/读心题材 ≥ 65%；基准：台词节奏基准.md v2.0） | 低于底线 → 请求 scene-writer 将独白最密集的 SEG 改写为角色对话 |
