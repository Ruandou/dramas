...
以下剧本因涉及特殊题材，**在当前资质下不可制作**：

| 剧本                         | 触发原因                     |
| ---------------------------- | ---------------------------- |
| 《超雄重生1995》             | 公安、司法（刑侦/警察）      |
| 《制式离婚》                 | 司法（律师/法庭）            |
| 《凤谋》                     | 政治（宫廷权谋争皇位）       |
| 《错嫁后我改写了王朝》       | 政治（宫廷权谋）             |
| 《将门孤女》                 | 军事、政治（军旅+朝堂）      |
...
| 《烬余》                     | 古装悬疑（6集） | 聚焦破案推理，无政治/军事主线，需确保不触及司法边界 |
| 《全楼都觉得我和女明星同居》 | 都市轻喜        | 纯都市恋爱，场景简单                                |
| 《都市债神》                 | 都市/神话       | 神话元素需合规处理（见内容合规规则）                |
| 《天工开物之匠魂》           | 古装/理工       | ⚠️ 边界 — 明末+阉党博弈可能触及政治，需调整设定     |
...
| 《冥牌调解处》               | 都市/悬疑       | 神话元素需合规处理（破除迷信导向）                  |

### 合规审查流程

1. **选题阶段**：对照本表确认题材合规，落入"特殊题材"的剧本直接排除
2. **边界剧本**（⚠️标记）：需逐集审查，确保不触发政治/军事/司法红线
